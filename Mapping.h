...
namespace Mapping
{
    ...
    {
    public:
        virtual void Map(const SwitchPro::Controller& from, X360::Controller& to) = 0;
    };
    ...
    namespace Analog
    {
        ...
        public:
            ...
            virtual void Map(const SwitchPro::Controller& from, X360::Controller& to);
        ...
        using LinearTriggerMapper = LinearMapper<SwitchPro::Axises, unsigned char, X360::Triggers, BYTE>;
        using BilinearTriggerMapper = BilinearMapper<SwitchPro::Axises, unsigned char, X360::Triggers, BYTE>;
        using LinearStickMapper = LinearMapper<SwitchPro::Axises, unsigned char, X360::Thumbs, SHORT>;
        using BilinearStickMapper = BilinearMapper<SwitchPro::Axises, unsigned char, X360::Thumbs, SHORT>;
    ...
    namespace Digital
    {
        ...
        {
        public:
            Mapper(SwitchPro::IEventPtr from, X360::IModifierPtr to);

            virtual void Map(const SwitchPro::Controller& from, X360::Controller& to);
            virtual YAML::Node Serialize() const;

        private:
            SwitchPro::IEventPtr event_;
    ...
    void Map(const Mappers&, const SwitchPro::Controller& from, X360::Controller& to);
}
